<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-xl font-bold">Add Contact Person</h2>
                <p class="text-xs font-medium mt-1 opacity-70">Create a contact and link them to client accounts.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="card bg-base-100 shadow-xl border border-base-200">
            <div class="card-body">
                <form action="{{ route('operations.contacts.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-control w-full">
                            <label class="label"><span class="label-text font-bold">Job Title / Designation</span></label>
                            <input type="text" name="job_title" class="input input-bordered w-full" placeholder="e.g. CEO, Project Manager" value="{{ old('job_title') }}" />
                        </div>
                        ...
                        <div class="form-control w-full md:col-span-2">
                            <label class="label"><span class="label-text font-bold">Link to Clients / Accounts</span></label>
                    ...
                    <div class="card-actions justify-end mt-6">
                        <button type="submit" class="btn btn-primary px-8">Create Contact</button>
                    </div>
                </form>
            </div>
        </div>
