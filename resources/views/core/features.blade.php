...
@section('title', 'HRMS Features & Modules | Solidrix OS')
@section('description', 'Explore the core HRMS modules of Solidrix OS including Attendance tracking, Payroll automation, Projects, and Employee Self-Service.')
@section('content')
