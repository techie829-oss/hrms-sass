...
@section('content')
<!-- Section 1: Hero -->
<section class="relative pt-24 pb-32 md:pt-32 md:pb-48 overflow-hidden bg-gradient-to-br from-primary/10 via-surface to-tertiary/10">
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-20 items-center">
        <div class="lg:col-span-7 z-10">
            <div class="inline-flex items-center gap-2 px-3 py-1.5 mb-8 rounded-full bg-secondary/10 border border-secondary/20 shadow-xl">
            ...
            <h1 class="font-headline text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight text-on-surface mb-8 leading-[1.05]">
                Architecture for <br><span class="bg-clip-text text-transparent bg-gradient-to-r from-primary to-tertiary">Human Capital.</span>
            </h1>
            ...
            <div class="flex flex-wrap gap-6">
                <a href="/modules" class="bg-gradient-to-br from-primary to-tertiary text-on-primary px-10 py-5 rounded-2xl font-bold text-lg shadow-xl hover:scale-[1.02] transition-transform text-center">
                    Explore the Suite
                </a>
                <a href="#story" class="bg-surface-container-lowest border border-outline-variant/20 px-10 py-5 rounded-2xl font-bold text-lg text-primary hover:bg-surface-container-low transition-all shadow-xl flex items-center justify-center gap-2">
                    Our Story <span class="material-symbols-outlined">expand_more</span>
                </a>
            </div>
        </div>
        <div class="lg:col-span-5 relative mt-12 lg:mt-0">
            <div class="w-full aspect-[4/5] bg-surface-container-low rounded-[3.5rem] overflow-hidden shadow-xl border-8 border-white transform lg:rotate-3 hover:rotate-0 transition-transform duration-700">
...
<section class="py-24 md:py-40 bg-surface">
    <div class="max-w-7xl mx-auto px-6">
        <div class="mb-16 space-y-4">
            ...
            <div class="h-2 w-32 bg-gradient-to-br from-primary to-tertiary rounded-full"></div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
            <div class="md:col-span-8 bg-surface-container-low p-10 md:p-16 rounded-[3rem] flex flex-col justify-between min-h-[450px] shadow-xl border border-outline-variant/10 group">
                <div class="space-y-8">
            ...
            <div class="md:col-span-4 bg-tertiary p-10 md:p-12 rounded-[3rem] text-on-tertiary shadow-xl bg-gradient-to-br from-primary to-tertiary flex flex-col justify-between group">
            ...
            <div class="md:col-span-4 bg-surface-container-highest p-10 rounded-[2.5rem] shadow-xl border border-outline-variant/10 group hover:bg-surface-container-high transition-colors">
            ...
            <div class="md:col-span-4 bg-secondary p-10 rounded-[2.5rem] text-on-secondary shadow-xl">
            ...
            <div class="md:col-span-4 bg-surface-container-lowest p-10 rounded-[2.5rem] border border-outline-variant/15 shadow-xl">
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex flex-col lg:flex-row gap-20 lg:gap-32 items-start">
            <div class="lg:w-1/2 lg:sticky lg:top-32 space-y-10">
                <h2 class="font-headline text-5xl md:text-6xl font-extrabold text-on-surface leading-tight tracking-tight">The Story Behind <br><span class="bg-clip-text text-transparent bg-gradient-to-r from-primary to-tertiary">{{ config('app.name', 'HRMS Solutions') }}</span></h2>
            ...
            <div class="lg:w-1/2 space-y-12 md:space-y-16 mt-12 lg:mt-0">
                <!-- Philosophy Card -->
                <div class="bg-surface-container-lowest p-10 md:p-16 rounded-[3.5rem] shadow-xl border-l-[12px] border-primary">
                ...
                <div class="rounded-[3.5rem] overflow-hidden shadow-xl h-[400px] md:h-[500px] border-8 border-white group relative">
...
<section class="py-24 md:py-40 bg-surface">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-16 lg:gap-24 items-start">
            <!-- Founder 1 -->
            <div class="group">
                <div class="relative mb-10 rounded-[3rem] overflow-hidden aspect-[4/5] bg-surface-container shadow-xl border-8 border-white">
...
<section class="py-32 md:py-48 px-6">
    <div class="max-w-7xl mx-auto rounded-[4rem] bg-inverse-surface p-16 md:p-32 text-center shadow-xl relative overflow-hidden group">
        <div class="relative z-10 space-y-12">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-8 pt-8">
                <a href="/contact" class="bg-gradient-to-br from-primary to-tertiary text-on-primary px-12 py-6 rounded-2xl font-black uppercase tracking-widest text-sm shadow-xl hover:scale-105 transition-transform text-center">
                    Book a Demo
                </a>
