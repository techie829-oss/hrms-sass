...
<section x-data="{ yearly: true }" class="py-20 md:py-32 px-6 md:px-12 bg-gradient-to-br from-surface-container-low to-surface overflow-hidden">
    <div class="max-w-7xl mx-auto text-center space-y-6 md:space-y-8 relative z-10">
        ...
        <h1 class="text-4xl md:text-6xl lg:text-7xl font-extrabold text-on-surface leading-[1.1] tracking-tight font-headline">
            Architect Your Workforce <br class="hidden md:block"><span class="bg-gradient-to-br from-primary to-tertiary bg-clip-text text-transparent">Without Compromise.</span>
        </h1>
        ...
        <div class="flex items-center justify-center gap-4 pt-6 md:pt-8">
            ...
            <div @click="yearly = !yearly" class="w-14 h-7 bg-surface-container-high rounded-full relative p-1 cursor-pointer border border-outline-variant/20 shadow-xl group">
...
<section class="pb-32 px-6 md:px-12 bg-surface">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <!-- Free -->
        <div class="bg-surface-container-low p-8 rounded-[2rem] border border-outline-variant/15 flex flex-col space-y-10 hover:bg-surface-bright transition-all shadow-xl group">
            <div class="space-y-2">
            ...
            <a href="/contact" class="w-full py-4 bg-surface-container-lowest text-on-surface font-black uppercase tracking-widest text-xs rounded-xl border border-outline-variant/15 hover:bg-surface-container-low transition-all text-center shadow-xl group-hover:scale-[1.02]">Request Demo</a>
        </div>
        ...
        <div class="bg-surface-container-low p-8 rounded-[2rem] border border-outline-variant/15 flex flex-col space-y-10 hover:bg-surface-bright transition-all shadow-xl group">
            ...
            <a href="/contact" class="w-full py-4 bg-surface-container-lowest text-on-surface font-black uppercase tracking-widest text-xs rounded-xl border border-outline-variant/15 hover:bg-surface-container-low transition-all text-center shadow-xl group-hover:scale-[1.02]">Choose Starter</a>
        </div>

        <!-- Professional -->
        <div class="bg-surface-container-low p-8 rounded-[2rem] border-4 border-primary ring-8 ring-primary/5 flex flex-col space-y-10 relative shadow-xl group scale-105 z-10">
            ...
            <a href="/contact" class="w-full py-4 bg-gradient-to-br from-primary to-tertiary text-on-primary font-black uppercase tracking-widest text-xs rounded-xl shadow-xl hover:opacity-90 transition-all text-center shadow-xl group-hover:scale-[1.02]">Start Professional</a>
        </div>

        <!-- Enterprise -->
        <div class="bg-inverse-surface p-8 rounded-[2rem] flex flex-col space-y-10 shadow-xl group">
            <div class="space-y-2">
...
<section class="py-32 px-6 md:px-12 bg-surface-container-low border-y border-outline-variant/15">
    <div class="max-w-7xl mx-auto space-y-20">
        <div class="flex flex-col md:flex-row justify-between items-end gap-10">
            ...
            <div class="px-5 py-2.5 bg-primary/10 text-primary text-[10px] font-black rounded-xl tracking-widest uppercase border border-primary/10 shadow-xl">Modular Precision</div>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div class="p-10 bg-surface-container-lowest rounded-[2.5rem] border border-outline-variant/15 space-y-8 group hover:bg-surface-bright transition-all shadow-xl border-b-8 border-b-primary/20">
            ...
            <div class="p-10 bg-surface-container-lowest rounded-[2.5rem] border border-outline-variant/15 space-y-8 group hover:bg-surface-bright transition-all shadow-xl border-b-8 border-b-secondary/20">
            ...
            <div class="p-10 bg-surface-container-lowest rounded-[2.5rem] border border-outline-variant/15 space-y-8 group hover:bg-surface-bright transition-all shadow-xl border-b-8 border-b-tertiary/20">
...
<section class="py-32 px-6 md:px-12 bg-surface">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-20">
        <div class="lg:col-span-1 space-y-10 lg:sticky lg:top-32 h-fit">
            <h2 class="text-4xl md:text-5xl font-extrabold text-on-surface tracking-tight font-headline leading-tight">Common <br><span class="bg-gradient-to-br from-primary to-tertiary bg-clip-text text-transparent">Inquiries.</span></h2>
            ...
            <div class="p-10 bg-surface-container-low rounded-[2.5rem] border border-outline-variant/15 space-y-6 shadow-xl">
        ...
        <div class="lg:col-span-2 space-y-8">
            <div class="space-y-6 p-8 md:p-10 bg-surface-container-lowest rounded-[2.5rem] border border-outline-variant/10 hover:border-primary/30 transition-all shadow-xl group">
    ...
    <div class="max-w-7xl mx-auto rounded-[3rem] md:rounded-[4rem] bg-inverse-surface p-12 lg:p-24 relative overflow-hidden group">
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
            ...
            <div class="flex flex-col sm:flex-row gap-6">
                <a href="/contact" class="px-10 py-5 bg-gradient-to-br from-primary to-tertiary text-on-primary font-black uppercase tracking-widest text-xs rounded-2xl shadow-xl hover:scale-105 transition-transform shadow-xl text-center">Request Architecture Demo</a>
