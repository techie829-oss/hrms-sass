...
@section('content')
<!-- Modules Hero -->
<section class="py-20 md:py-32 px-6 md:px-12 bg-gradient-to-br from-primary/10 via-surface to-tertiary/10 overflow-hidden">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-16 relative z-10">
        <div class="md:w-1/2 space-y-6 md:space-y-8 text-center md:text-left">
            <div class="inline-flex items-center px-4 py-1.5 bg-primary/10 text-primary rounded-full text-[10px] md:text-xs font-bold tracking-widest uppercase shadow-xl border border-primary/10 mx-auto md:mx-0">
                Modular Architecture
            </div>
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-extrabold text-on-surface leading-[1.1] tracking-tight font-headline">
                Modular Architecture for <br class="hidden md:block"><span class="bg-clip-text text-transparent bg-gradient-to-r from-primary to-tertiary">Modern Teams.</span>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 pt-4">
                <a href="/contact" class="w-full sm:auto bg-gradient-to-br from-primary to-tertiary px-8 py-4 text-on-primary font-bold rounded-xl shadow-lg hover:scale-105 transition-transform shadow-xl text-center">Book a Demo</a>
        ...
        <div class="md:w-1/2 relative h-[350px] md:h-[450px] flex items-center justify-center mt-12 md:mt-0 w-full">
            ...
            <div class="relative z-10 grid grid-cols-2 gap-4 md:gap-6 w-full max-w-md">
                <div class="bg-surface-container-lowest p-6 md:p-8 rounded-2xl shadow-xl border border-outline-variant/10 mt-8 transform hover:-translate-y-2 transition-transform group">
                ...
                <div class="bg-surface-container-lowest p-6 md:p-8 rounded-2xl shadow-xl border border-outline-variant/10 transform hover:-translate-y-2 transition-transform group">
                ...
                <div class="bg-surface-container-lowest p-6 md:p-8 rounded-2xl shadow-xl border border-outline-variant/10 -mt-4 transform hover:-translate-y-2 transition-transform group">
    ...
    <div class="max-w-7xl mx-auto space-y-16 md:space-y-24">
        <div class="flex flex-col md:flex-row justify-between items-end gap-8 mb-12 md:mb-16">
            ...
            <div class="hidden md:flex gap-3 pb-2">
                <div class="w-3 h-3 rounded-full bg-primary shadow-xl"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <!-- HR Core -->
            <div class="bg-surface-container-low p-8 rounded-[2rem] border border-outline-variant/15 space-y-6 hover:bg-surface-bright transition-all shadow-xl group">
        ...
        <div class="mt-16 bg-surface-container-low p-8 md:p-12 rounded-[2.5rem] md:rounded-[3rem] border border-outline-variant/15 flex flex-col lg:flex-row items-center justify-between gap-10 shadow-xl">
            <div class="flex-1 space-y-6 md:space-y-8">
                ...
                <div class="flex flex-wrap gap-4 md:gap-6">
                    <span class="bg-surface-container-lowest px-5 py-2.5 rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest text-on-surface flex items-center gap-3 border border-outline-variant/10 shadow-xl">
            ...
            <div class="w-full lg:w-auto">
                <a href="#" class="w-full lg:w-auto bg-gradient-to-br from-primary to-tertiary text-on-primary px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-sm shadow-xl inline-block text-center hover:scale-105 transition-transform">See Insights</a>
            </div>
        </div>
    </div>
</section>
...
<section class="py-24 md:py-40 px-6 bg-surface-container-low border-y border-outline-variant/15 overflow-hidden">
    <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        <div class="w-full lg:w-1/2 space-y-10 md:space-y-12">
            <h2 class="text-4xl md:text-6xl font-extrabold text-on-surface font-headline tracking-tight leading-[1.1]">Pick Your <span class="bg-clip-text text-transparent bg-gradient-to-r from-primary to-tertiary">Mix.</span></h2>
            ...
            <div class="space-y-6 md:space-y-8">
                <div class="flex items-start gap-6 p-6 md:p-8 rounded-[2rem] bg-surface-container-lowest shadow-xl border border-primary/10 group">
        ...
        <div class="w-full lg:w-1/2 relative bg-surface-dim rounded-[3rem] p-8 md:p-16 min-h-[450px] md:min-h-[550px] flex items-center justify-center border border-outline-variant/10 shadow-xl mt-12 lg:mt-0">
            ...
            <div class="relative grid grid-cols-2 gap-4 md:gap-6 w-full">
                <div class="col-span-2 bg-surface-container-lowest/90 backdrop-blur-xl p-6 rounded-2xl shadow-xl border border-white/40 flex items-center justify-between mb-2">
                    ...
                    <span class="text-[10px] font-black text-primary px-3 py-1.5 bg-primary/10 rounded-full shadow-xl uppercase tracking-tighter">3 Active</span>
                </div>
...
<section class="py-24 md:py-40 px-6 relative overflow-hidden bg-surface">
    <div class="max-w-4xl mx-auto text-center space-y-10 md:space-y-12 relative z-10">
        <h2 class="text-4xl md:text-7xl font-extrabold text-on-surface font-headline tracking-tight leading-[1.1]">Ready to build your <br><span class="bg-clip-text text-transparent bg-gradient-to-r from-primary to-tertiary">custom</span> HR suite?</h2>
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-6 pt-6">
            <a href="/contact" class="px-12 py-5 bg-primary text-on-primary font-bold rounded-2xl shadow-xl hover:scale-105 transition-transform bg-gradient-to-br from-primary to-tertiary text-center">Book a Demo</a>
            <a href="/contact" class="px-12 py-5 bg-surface-container-lowest text-on-surface font-bold rounded-2xl border border-outline-variant/15 hover:bg-surface-container-low transition-all shadow-xl text-center">Talk to Sales</a>
        </div>
    </div>
</section>
@endsection
