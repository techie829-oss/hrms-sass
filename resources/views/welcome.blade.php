...
<section class="landing-hero">
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div class="lg:col-span-7">
            <div class="inline-flex items-center gap-2 px-3 py-1 mb-6 md:mb-8 rounded-full bg-surface-container-high border border-primary/10 shadow-xl">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="/contact" class="landing-btn-primary">
                    Book a Demo
                </a>
        ...
        <div class="lg:col-span-5 relative mt-12 lg:mt-0">
            <div class="w-full aspect-[4/5] rounded-[2rem] overflow-hidden shadow-xl bg-surface-container-lowest border-4 border-surface-container-lowest p-2 transform lg:rotate-2 hover:rotate-0 transition-transform duration-700">
            ...
            <!-- Floating Data Card -->
            <div class="absolute -bottom-6 -left-4 md:-bottom-8 md:-left-12 p-5 md:p-6 bg-surface-container-lowest/90 backdrop-blur-xl rounded-2xl shadow-xl border border-outline-variant/20 max-w-[200px] md:max-w-[240px]">
...
<!-- Feature Bento Grid -->
<section class="landing-section-spacing bg-surface-container-low">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
            <!-- Large Feature Card -->
            <div class="md:col-span-8 bg-surface-container-lowest rounded-[2rem] p-8 md:p-10 shadow-xl relative overflow-hidden group border border-outline-variant/10">
            ...
            <div class="md:col-span-4 bg-secondary rounded-[2rem] p-8 md:p-10 shadow-xl text-on-secondary flex flex-col justify-between group">
                <div>
            ...
            <!-- Medium Feature -->
            <div class="md:col-span-4 bg-surface-container-highest rounded-[2rem] p-8 border border-outline-variant/20 shadow-xl flex flex-col justify-between group hover:bg-surface-container-high transition-colors">
                <div class="space-y-6">
            ...
            <div class="md:col-span-8 bg-gradient-to-br from-surface-container to-surface-container-high rounded-[2rem] p-8 md:p-10 flex flex-col md:flex-row items-center gap-8 md:gap-10 shadow-xl border border-outline-variant/10 group">
                <div class="flex-1">
...
<section class="landing-section-spacing bg-surface px-6 overflow-hidden">
    <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
        <div class="lg:w-1/2 space-y-10 md:space-y-12">
            <h2 class="text-3xl md:text-5xl font-extrabold font-headline tracking-tight text-on-surface">One Interface.<br class="hidden md:block"><span class="bg-gradient-to-br from-primary to-tertiary bg-clip-text text-transparent">Infinite Control.</span></h2>
            <div class="space-y-6 md:space-y-8">
                <div class="flex gap-5 md:gap-6 group">
                    <div class="shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold shadow-xl group-hover:scale-110 transition-transform">1</div>
                    <div>
                ...
                <div class="flex gap-5 md:gap-6 group">
                    <div class="shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold shadow-xl group-hover:scale-110 transition-transform">2</div>
                    <div>
                ...
                <div class="flex gap-5 md:gap-6 group">
                    <div class="shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold shadow-xl group-hover:scale-110 transition-transform">3</div>
                    <div>
        ...
        <div class="lg:w-1/2 relative mt-12 lg:mt-0">
            <div class="bg-surface-container-lowest p-2 rounded-[2.5rem] shadow-2xl transform lg:rotate-3 hover:rotate-0 transition-transform duration-700 border-4 border-surface-container-low shadow-xl">
...
<!-- Stats Section -->
<section class="landing-section-spacing bg-gradient-to-br from-surface-container-low to-surface">
        ...
        <div class="lg:w-1/2 relative w-full">
            <div class="grid grid-cols-2 gap-4 md:gap-6">
                <div class="space-y-4 md:space-y-6 pt-8 md:pt-12">
                    <div class="bg-surface-container-lowest p-6 md:p-8 rounded-[2rem] shadow-xl border border-outline-variant/10 group hover:-translate-y-1 transition-transform">
                    ...
                    <div class="bg-primary p-6 md:p-8 rounded-[2rem] shadow-xl text-on-primary bg-gradient-to-br from-primary to-tertiary group hover:-translate-y-1 transition-transform">
                ...
                <div class="space-y-4 md:space-y-6">
                    <div class="bg-tertiary p-6 md:p-8 rounded-[2rem] shadow-xl text-on-tertiary group hover:-translate-y-1 transition-transform">
...
<section class="landing-section-spacing bg-surface px-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            <div class="bg-surface-container-lowest p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-outline-variant/10 relative group hover:-translate-y-2 transition-transform duration-500">
                ...
                <div class="flex items-center gap-5">
                    <div class="w-14 h-14 md:w-16 md:h-16 rounded-full overflow-hidden border-2 border-primary/20 shadow-xl">
            ...
            <div class="bg-surface-container-lowest p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-outline-variant/10 relative group hover:-translate-y-2 transition-transform duration-500">
                ...
                <div class="flex items-center gap-5">
                    <div class="w-14 h-14 md:w-16 md:h-16 rounded-full overflow-hidden border-2 border-tertiary/20 shadow-xl">
...
<section class="landing-section-spacing px-6 bg-surface-container-low border-y border-outline-variant/15">
    <div class="max-w-3xl mx-auto space-y-12 md:space-y-16">
        ...
        <div class="space-y-4 md:space-y-6">
            <div class="bg-surface-container-lowest p-6 md:p-8 rounded-2xl border border-outline-variant/10 shadow-xl group">
...
<section class="py-24 md:py-32 px-6 relative overflow-hidden">
    <div class="max-w-7xl mx-auto rounded-[3rem] md:rounded-[4rem] bg-inverse-surface p-10 md:p-24 relative overflow-hidden text-center shadow-xl">
        <div class="relative z-10 max-w-3xl mx-auto space-y-8 md:space-y-10">
            ...
            <div class="flex flex-wrap justify-center gap-4 md:gap-6 pt-4">
                <a href="/contact" class="w-full sm:w-auto px-10 py-5 bg-primary text-on-primary font-bold rounded-xl shadow-xl text-lg hover:scale-105 transition-transform bg-gradient-to-br from-primary to-tertiary">Book a Demo</a>
