        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="stats shadow-xl bg-surface-container-lowest border border-outline-variant/15 rounded-[2rem] overflow-hidden md:col-span-4">
                <div class="stat p-8">
                    ...
                    <div class="stat-value text-primary font-headline text-4xl">42</div>
                    <div class="stat-desc font-medium mt-1">↗︎ 4 new this month</div>
                </div>
                ...
                <div class="stat p-8">
                    ...
                    <div class="stat-title font-bold uppercase tracking-widest text-[10px] text-on-surface-variant">Monthly Revenue</div>
                    <div class="stat-value text-secondary font-headline text-4xl">₹4.2M</div>
                    <div class="stat-desc font-medium mt-1">↗︎ 12% growth</div>
                </div>
            ...
            <div class="lg:col-span-2 space-y-8">
                <div class="bg-surface-container-lowest p-8 md:p-10 rounded-[2.5rem] premium-shadow border border-outline-variant/15">
                    <div class="flex justify-between items-center mb-8">
                        ...
                        <a href="#" class="btn btn-sm btn-ghost rounded-xl font-bold uppercase tracking-widest text-[10px]">View All Tenants</a>
                    </div>
                        ...
                        <table class="table w-full">
                            ...
                            <tbody class="text-on-surface font-medium">
                                <tr class="border-b border-outline-variant/5">
                                    <td>Lumina Tech</td>
                                    <td><span class="badge badge-ghost font-mono text-[10px]">lumina</span></td>
                                    <td><span class="badge badge-primary badge-outline text-[10px] font-bold">PROFESSIONAL</span></td>
                                    <td><span class="badge badge-success text-[10px] text-white font-bold">ACTIVE</span></td>
                                </tr>
                                <tr class="border-b border-outline-variant/5">
                                    <td>Forge Mfg</td>
                                    <td><span class="badge badge-ghost font-mono text-[10px]">forge</span></td>
                                    <td><span class="badge badge-secondary badge-outline text-[10px] font-bold">STARTER</span></td>
                                    <td><span class="badge badge-success text-[10px] text-white font-bold">ACTIVE</span></td>
                                </tr>
                                <tr class="border-b border-outline-variant/5">
                                    <td>Aether Studio</td>
                                    <td><span class="badge badge-ghost font-mono text-[10px]">aether</span></td>
                                    <td><span class="badge badge-ghost badge-outline text-[10px] font-bold">FREE</span></td>
                                    <td><span class="badge badge-warning text-[10px] text-white font-bold">TRIAL</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="space-y-8">
                <div class="bg-surface-container-lowest p-8 rounded-[2.5rem] premium-shadow border border-outline-variant/15">
                    ...
                    <ul class="menu bg-surface-container-low rounded-2xl p-2 gap-1 font-medium">
                        <li><a class="py-3 hover:bg-primary/5 hover:text-primary"><span class="material-symbols-outlined text-xl">add_business</span> Create Tenant</a></li>
                        <li><a class="py-3 hover:bg-primary/5 hover:text-primary"><span class="material-symbols-outlined text-xl">settings_applications</span> System Settings</a></li>
                        <li><a class="py-3 hover:bg-primary/5 hover:text-primary"><span class="material-symbols-outlined text-xl">security</span> Security Audit</a></li>
                        <li><a class="py-3 hover:bg-primary/5 hover:text-primary text-error"><span class="material-symbols-outlined text-xl">report_problem</span> Critical Alerts <span class="badge badge-error text-white font-black text-[10px]">3</span></a></li>
                    </ul>
                </div>
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="space-y-4">
                            <div class="flex justify-between items-center text-xs">
                                ...
                                <span class="font-black">24%</span>
                            </div>
                            <progress class="progress progress-primary w-full h-2 bg-white/20" value="24" max="100"></progress>
                            <div class="flex justify-between items-center text-xs">
                                <span class="font-bold opacity-70">Memory</span>
                                <span class="font-black">4.2GB / 8GB</span>
                            </div>
                            <progress class="progress progress-secondary w-full h-2 bg-white/20" value="52" max="100"></progress>
                        </div>
                    </div>
                </div>
            </div>
