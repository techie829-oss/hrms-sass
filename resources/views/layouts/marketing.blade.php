                ...
                <div class="lg:w-1/4 xl:w-[28%] shrink-0">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="tel:+917007420572" class="text-sm text-gray-600 hover:text-blue-600 transition-colors">+91 70074 20572</a>
                        </div>
                        <div class="flex items-center gap-3 pt-1">
                            <a href="https://wa.me/917007420572" target="_blank" class="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-green-50 text-green-700 hover:bg-green-100 transition-colors text-sm font-semibold border border-green-200">
