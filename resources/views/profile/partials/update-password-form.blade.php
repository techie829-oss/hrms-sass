<section class="text-left">
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Confirm Password')" class="text-slate-700 font-semibold" />
        ...
        <div class="flex items-center gap-4 pt-4 border-t border-slate-100">
            ...
            @if (session('status') === 'password-updated')
                ...
                ><span class="material-symbols-outlined text-green-600 text-sm">check_circle</span>{{ __('Password Updated.') }}</p>
            @endif
        </div>
    </form>
</section>
